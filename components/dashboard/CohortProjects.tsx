    ...
    const projectList: ProjectInfo[] = [
        {
            ...
            links: [
                "https://moloch.mic0.dev",
                "https://git.mic0.dev/mico/idle_moloch",
            ],
        },
        {
            name: "CharmverseVII",
            description:
                "Token-gated repository of the cohort's educational and organizational content.",
            links: [
                "https://app.charmverse.io/join?domain=raidguild-cohort-season-7",
            ],
        },
        {
            name: "CohortView.eth",
            description:
                "The cornerstone of the Hamsterverse, showcasing team projects through the unique Mad Libs/Viewmaster lens. The hamster narrator becomes the 'host' of this show, connecting everything together.",
