  ...
  return (
    <Card className="bg-gradient-to-t from-[#262f41] to-[#475778] backdrop-blur-sm border-white pb-4">
      ...
      <CardContent className="flex flex-col gap-8 pt-8">
        <div>
          <p className="text-base text-rg-red font-serif pb-3">External links</p>
        ...
        <div>
          <p className="text-base text-rg-red font-serif">The Hamsters' Journey</p>
          <p className="text-xs text-white h-[80px] overflow-y-scroll">In a land ruled by tiny paws, the hamsters empire. With bravery and wit, they sail the Uniswap seas, conquer the Dune Desert, and protect their kingdom through DAOhaus. Join them on their quest to defeat Moloch!</p>
        </div>
      </CardContent>
    </Card>
  )
